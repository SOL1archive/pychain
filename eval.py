...
use_bf16 = True
max_length = 512  # Truncate inputs to this length
max_new_tokens = 512  # Allow enough room for full solution generation
...
for subject in subjects_to_evaluate:
    ...
    model_path = os.path.join(merged_models_folder, f"{subject}")
